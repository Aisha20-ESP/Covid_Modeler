...
--
-- Hôte : localhost
-- Généré le :  lun. 12 avr. 2021 à 21:06
...
CREATE TABLE `details_cas` (
  ...
  `nbre_deces` int(11) NOT NULL,
  `nbre_test` int(11) NOT NULL,
...
CREATE TABLE `details_cas_communes` (
  `id` int(11) NOT NULL,
  `nbre_nouv_cas` int(11) NOT NULL,
  `nom_fichier_source` varchar(70) NOT NULL,
  `date_heure_extraction` date NOT NULL,
...
CREATE TABLE `details_cas_departements` (
  `id` int(11) NOT NULL,
  `nbre_nouv_cas` int(11) NOT NULL,
  `nom_fichier_source` varchar(70) NOT NULL,
  `date_heure_extraction` date NOT NULL,
...
CREATE TABLE `details_cas_regions` (
  `id` int(11) NOT NULL,
  `nbre_nouv_cas` int(11) NOT NULL,
  `nom_fichier_source` varchar(70) NOT NULL,
  `date_heure_extraction` date NOT NULL,
...
--
ALTER TABLE `details_cas`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `details_cas_communes`
--
ALTER TABLE `details_cas_communes`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `details_cas_departements`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `details_cas_regions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `region_id` (`region_id`);
...
--
ALTER TABLE `details_cas_communes`
  ADD CONSTRAINT `details_cas_communes_ibfk_1` FOREIGN KEY (`commune_id`) REFERENCES `commune` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `details_cas_departements`
--
ALTER TABLE `details_cas_departements`
  ADD CONSTRAINT `details_cas_departements_ibfk_1` FOREIGN KEY (`departement_id`) REFERENCES `departement` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `details_cas_regions`
--
ALTER TABLE `details_cas_regions`
  ADD CONSTRAINT `details_cas_regions_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
